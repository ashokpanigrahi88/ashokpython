...
from oratechetl import (commonutil,dbfuncs)
import numpy as np
import pandas  as pd
import csv
connection = db.db_connection
DEFAULT_PARAMS = {
    'UPDATES_DIR' :  os.path.join(etl_settings.ADMIN_SCRIPTS_DIR,'updates\\'),
    'UPGRADE_DIR'  : os.path.join(etl_settings.ADMIN_SCRIPTS_DIR,'upgrade\\'),
    'ACTIVE_DIR'  : os.path.join(etl_settings.ADMIN_SCRIPTS_DIR,'upgrade\\'),
